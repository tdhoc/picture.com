    ...
    return (
        t.extend(e.prototype, {
            ...
            support: (function(e) {
                ...
                return (
                    document.body ? i() : t(document).on("DOMContentLoaded", i),
                    n
                );
            ...
            slide: function(t, e) {
                ...
                if (o !== t && 1 !== this.num) {
                    if (
                        (e || (e = this.options.transitionSpeed),
            ...
            close: function() {
                function t(i) {
                    i.target === e.container[0] &&
                        (e.container.off(e.support.transition.end, t),
                        e.handleClose());
                }
                var e = this;
                ...
                if (!(s.length > 1 || (n && 1 !== n)))
                    if (
                        ...
                        for (
                            ...
                            (o = i.pop()),
                                this.translateX(o, e + this.positions[o], 0);
            },
            ...
            setTitle: function(t) {
                ...
                i.length &&
                    ...
                    e && i[0].appendChild(document.createTextNode(e)));
            },
            ...
            unloadSlide: function(t) {
                var e, i;
                null !== (i = (e = this.slides[t]).firstChild) &&
                    e.removeChild(i);
            },
            ...
            initEventListeners: function() {
                function e(t) {
                    var e =
                        ...
                        i.support.transition.end === t.type
                            ? "transitionend"
                            : t.type;
                    i["on" + e](t);
                }
                ...
                t(window).on("resize", e),
                    ...
                    this.support.transition &&
                        s.on(this.support.transition.end, e),
            ...
            initWidget: function() {
                function e(t) {
                    t.target === i.container[0] &&
                        (i.container.off(i.support.transition.end, e),
                        i.handleOpen());
                }
                var i = this;
                return (
                ...
                initSlides: function(t) {
                    t ||
                        ...
                        this.indicatorContainer.length &&
                            ((this.indicatorPrototype = document.createElement(
                                "li"
                            )),
        ...
        return (
            t.extend(e.prototype, {
                ...
                videoFactory: function(e, i, s) {
                    ...
                    if (
                        (u.addClass(d.videoContentClass),
                        g && (c.title = g),
                        m.canPlayType)
                    )
                            ...
                            (s || t(m))
                                ...
                                .on("pause", function() {
                                    m.seeking ||
                                        ...
                                        u
                                            .removeClass(
                                                h.options.videoLoadingClass
                                            )
                                            .removeClass(
                                                h.options.videoPlayingClass
                                            ),
                                        r &&
                                            h.container.addClass(
                                                h.options.controlsClass
                                            ),
                                ...
                                .on("playing", function() {
                                    (l = !1),
                                        ...
                                        h.container.hasClass(
                                            h.options.controlsClass
                                        )
                                            ? ((r = !0),
                                              h.container.removeClass(
                                                  h.options.controlsClass
                                              ))
                                            : (r = !1);
                                })
        ...
        return (
            t.extend(s.prototype, {
                ...
                play: function() {
                    var t = this;
                    this.playStatus ||
                        (this.listeners.play(), (this.playStatus = 1)),
                        this.ready
                            ? !this.hasPlayed &&
                              (this.clickToPlay ||
                                  (window.navigator &&
                ...
                textFactory: function(t, e) {
                    ...
                    return o
                        ? (void 0 === this.getItemProperty(t, n.urlProperty) &&
                          ...
                          void 0 ===
                              this.getItemProperty(t, n.videoPosterProperty) &&
    ...
    (function(t) {
        ...
        t(document).on("click", "[data-gallery]", function(i) {
            var s = t(this).data("gallery"),
                ...
                l = t.extend(
                    o.data(),
                    { container: o[0], index: this, event: i },
                    a
                ),
                r = t('[data-gallery="' + s + '"]');
