    ...
    function t(t) {
        ...
        return function(r) {
            ...
            n &&
                ...
                !1 !== this._trigger(t, e.Event(t, { delegatedEvent: r })) &&
        ...
        e.widget("blueimp.fileupload", {
                        ...
                        ? e.support.xhrFormDataFileUpload &&
                          (t.postMessage
                              ...
                              : (r._isInstanceOf("FormData", t.formData)
                                    ? (i = t.formData)
                                    : ((i = new FormData()),
                                      e.each(this._getFormData(t), function(
                                          e,
                                          t
                                      ) {
                ...
                return (
                    !(
                        !(
                            this._isXHRUpload(t) &&
                            u &&
                            (l || ("function" === e.type(p) ? p(t) : p) < a)
                        ) || t.data
                    ) &&
                    (!!i ||
                        (l >= a
                            ? ((s.error = t.i18n("uploadedBytes")),
                              this._getXHRPromise(!1, t.context, [
                                  null,
                                  "error",
                                  s.error
                              ]))
            ...
            _beforeSend: function(e, t) {
                0 === this._active &&
                    ...
                    (t._progress.total = t.total =
                        this._getTotal(t.files) || 1),
                                ...
                                (
                                    ...
                                    .always(function(e, t, i) {
                                        if (
                                            ...
                                            for (
                                                var r = a._slots.shift();
                                                r;

                                            ) {
                                                if (
                                                    "pending" ===
                                                    a._getDeferredState(r)
                                                ) {
                                                    r.resolve();
                                                    break;
                                                }
            ...
            _getDroppedFiles: function(t) {
                ...
                return i &&
                    i.length &&
                    (i[0].webkitGetAsEntry || i[0].getAsEntry)
            ...
            _getSingleFileInputFiles: function(t) {
                ...
                if ((i = e.makeArray(t.prop("files"))).length)
                    void 0 === i[0].name &&
                        i[0].fileName &&
            ...
            _onDrop: function(t) {
                t.dataTransfer =
                    t.originalEvent && t.originalEvent.dataTransfer;
                var i = this,
                    r = t.dataTransfer,
                    n = {};
                r &&
            ...
            add: function(t) {
                ...
                t &&
                    ...
                    (t.fileInput && !t.files
                        ? this._getFileInputFiles(t.fileInput).always(function(
                              e
                          ) {
                        ...
                        return (
                            (s.abort = function() {
                                return (
                                    ...
                                    i
                                        ? i.abort()
                                        : (o.reject(null, "abort", "abort"), s)
                                );
                            }),
                            this._getFileInputFiles(t.fileInput).always(
                                function(e) {
                                    r ||
                                        (e.length
                                            ? ((t.files = e),
