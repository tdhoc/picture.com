...
!(function(f, _) {
    ...
    if (
        ...
        "IntersectionObserverEntry" in f &&
        "intersectionRatio" in f.IntersectionObserverEntry.prototype
    )
        "isIntersecting" in f.IntersectionObserverEntry.prototype ||
            Object.defineProperty(
                f.IntersectionObserverEntry.prototype,
                "isIntersecting",
                {
                    get: function() {
        ...
        (t.prototype.THROTTLE_TIMEOUT = 100),
            ...
            (t.prototype._monitorIntersections = function() {
                this._monitoringIntersections ||
                    ...
                    this.POLL_INTERVAL
                        ...
                        : (n(f, "resize", this._checkForIntersections, !0),
                          n(_, "scroll", this._checkForIntersections, !0),
                          this.USE_MUTATION_OBSERVER &&
                              "MutationObserver" in f &&
                              ((this._domObserver = new MutationObserver(
                                  this._checkForIntersections
                              )),
                              this._domObserver.observe(_, {
                                  attributes: !0,
                                  childList: !0,
                                  characterData: !0,
                                  subtree: !0
            ...
            (t.prototype._unmonitorIntersections = function() {
                this._monitoringIntersections &&
                    ...
                    o(f, "resize", this._checkForIntersections, !0),
                    o(_, "scroll", this._checkForIntersections, !0),
                    this._domObserver &&
            ...
            (t.prototype._computeTargetAndRootIntersection = function(t, e) {
                if ("none" != f.getComputedStyle(t).display) {
                    for (
                        var n, o, i, r, s, h, c, a, u = m(t), l = v(t), p = !1;
                        !p;

                    ) {
                        var d = null,
                            g = 1 == l.nodeType ? f.getComputedStyle(l) : {};
            ...
            (f.IntersectionObserver = t),
            (f.IntersectionObserverEntry = a);
    }
    function a(t) {
        (this.time = t.time),
