    ...
    (function(e) {
        ...
        (e.transform = function(i, a, o, n, r) {
            ...
            (e.renderImageToCanvas = function(e, t, i, a, o, n, r, s, l, d) {
                return (
                    e.getContext("2d").drawImage(t, i, a, o, n, r, s, l, d), e
                );
            }),
            ...
            (e.parseMetaData = function(t, i, a, o) {
                ...
                (!!(
                    ...
                    e.readFile(
                        ...
                        function(t) {
                            if (t.target.error)
                                return console.log(t.target.error), void i(o);
                            var r,
                                s,
                                l,
                                d,
                            ...
                            if (65496 === u.getUint16(0)) {
                                ...
                                !a.disableImageHead &&
                                    h > 6 &&
                                    (c.slice
                                        ? (o.imageHead = c.slice(0, h))
                                        : (o.imageHead = new Uint8Array(
                                              c
                                          ).subarray(0, h)));
                            } else
                                console.log(
                ...
                if (!n.disableExif) {
                    ...
                    if (1165519206 === t.getUint32(i + 4))
                        if (d + 8 > t.byteLength)
                            ...
                            42 === t.getUint16(d + 2, r)
                                ? ((s = t.getUint32(d + 4, r)),
                                  (o.exif = new e.ExifMap()),
                                  (s = e.parseExifTags(t, d, d + s, r, o)) &&
