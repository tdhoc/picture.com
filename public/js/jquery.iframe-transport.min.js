!(function(e) {
    ...
    var t = 0,
        r = e,
        n = "parseJSON";
    "JSON" in window && "parse" in JSON && ((r = JSON), (n = "parse")),
        e.ajaxTransport("iframe", function(r) {
            if (r.async) {
                ...
                return {
                    send: function(p, m) {
                        (n = e('<form style="display:none;"></form>')).attr(
                            "accept-charset",
                            r.formAcceptCharset
                        ),
                            (o = /\?/.test(r.url) ? "&" : "?"),
                            "DELETE" === r.type
                                ? ((r.url = r.url + o + "_method=DELETE"),
                                  (r.type = "POST"))
                                : "PUT" === r.type
                                ? ((r.url = r.url + o + "_method=PUT"),
                                  (r.type = "POST"))
                                : "PATCH" === r.type &&
                                  ((r.url = r.url + o + "_method=PATCH"),
                                  (r.type = "POST")),
                            (a = e(
                                '<iframe src="' +
                                    i +
            ...
            converters: {
                ...
                "iframe xml": function(t) {
                    ...
                    return r && e.isXMLDoc(r)
                        ? r
                        : e.parseXML(
                              (r.XMLDocument && r.XMLDocument.xml) ||
                                  e(r.body).html()
                          );
                },
