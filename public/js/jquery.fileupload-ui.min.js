        ...
        e.widget("blueimp.fileupload", e.blueimp.fileupload, {
            options: {
                ...
                getNumberOfFiles: function() {
                    return this.filesContainer.children().not(".processing")
                        .length;
                },
                getFilesFromResponse: function(t) {
                    return t.result && e.isArray(t.result.files)
                        ? t.result.files
                        : [];
                },
                add: function(t, i) {
                    ...
                    (i.context = r
                        ...
                        .data("data", i)
                        .addClass("processing")),
                        o.filesContainer[o.prependFiles ? "prepend" : "append"](
                            i.context
                        ),
                ...
                send: function(t, i) {
                    if (t.isDefaultPrevented()) return !1;
                    var n =
                        e(this).data("blueimp-fileupload") ||
                        e(this).data("fileupload");
                    return (
                        i.context &&
                            i.dataType &&
                    ...
                    var n,
                        ...
                        o =
                            ...
                            e(this).data("fileupload"),
                        a = (
                            i.getFilesFromResponse ||
                            o.options.getFilesFromResponse
                        )(i);
                    i.context
                        ? i.context.each(function(s) {
                              var d = a[s] || {
            ...
            _addFinishedDeferreds: function(t) {
                return (
                    t || (t = e.Deferred()), this._finishedUploads.push(t), t
                );
            },
                ...
                t.bind("dragstart", function(e) {
                    try {
                        e.originalEvent.dataTransfer.setData(
                            "DownloadURL",
                            ["application/octet-stream", n, i].join(":")
                        );
                    } catch (e) {}
                });
            },
            ...
            _renderTemplate: function(t, i) {
                ...
                return n instanceof e
                    ? n
                    : e(this.options.templatesContainer)
                          .html(n)
                          .children();
            },
            ...
            _startHandler: function(t) {
                ...
                var i = e(t.currentTarget),
                    n = i.closest(".template-upload").data("data");
