            ...
            processActions: {
                loadImage: function(a, t) {
                    ...
                    return ("number" === e.type(t.maxFileSize) &&
                        r.size > t.maxFileSize) ||
                        (t.fileTypes && !t.fileTypes.test(r.type)) ||
                        !i(
                            r,
                            function(e) {
                                e.src && (a.img = e), s.resolveWith(n, [a]);
                            },
                            t
                        )
                        ? a
                ...
                resizeImage: function(a, t) {
                    ...
                    if (a.exif) {
                        if (
                            ...
                            return i(n, o, t), s.promise();
                        a.orientation
                            ? delete t.orientation
                            : (a.orientation = t.orientation);
                    }
                    return l ? (o(i.scale(l, t)), s.promise()) : a;
                },
                ...
                loadImageMetaData: function(a, t) {
                    ...
                    return (
                        i.parseMetaData(
                            a.files[a.index],
                            function(i) {
                                e.extend(a, i), r.resolveWith(n, [a]);
                            },
                            t
                        ),
                        r.promise()
                ...
                saveImageMetaData: function(e, i) {
                    if (
                        !(e.imageHead && e.canvas && e.canvas.toBlob) ||
                        i.disabled
                    )
                        return e;
                    var a = e.files[e.index],
                        t = new Blob(
                            [e.imageHead, this._blobSlice.call(a, 20)],
                            { type: a.type }
                        );
